...
import com.ywwxhz.crash.activity.DefaultErrorActivity;
...
public final class CustomActivityOnCrash {
    ...
    private static final String EXTRA_RESTART_ACTIVITY_CLASS = "com.ywwxhz.crash.EXTRA_RESTART_ACTIVITY_CLASS";
    private static final String EXTRA_SHOW_ERROR_DETAILS = "com.ywwxhz.crash.EXTRA_SHOW_ERROR_DETAILS";
    private static final String EXTRA_STACK_TRACE = "com.ywwxhz.crash.EXTRA_STACK_TRACE";
    private static final String EXTRA_LOG_FILE_PATH = "com.ywwxhz.crash.EXTRA_LOG_FILE_PATH";

    //General constants
    private final static String TAG = "CustomActivityOnCrash";
    private static final String INTENT_ACTION_ERROR_ACTIVITY = "com.ywwxhz.crash.ERROR";
    private static final String INTENT_ACTION_RESTART_ACTIVITY = "com.ywwxhz.crash.RESTART";
    ...
    public static String getAllErrorDetailsFromIntent(Context context, Intent intent) {
        ...
        errorDetails += "For more detail see log files. \n log file path: " + intent.getStringExtra(EXTRA_LOG_FILE_PATH);
        return errorDetails;
    }
     ...
     * false if you want it not to launch and com.ywwxhz.crash silently.
     * This has no effect in API<14 and the error activity is always launched.
     * The default is true (the app will be brought to front when a com.ywwxhz.crash occurs).
     */
    ...
    /**
     * Returns the error activity class to launch when a com.ywwxhz.crash occurs.
     *
    ...
    /**
     * Sets the error activity class to launch when a com.ywwxhz.crash occurs.
    ...
    /**
     * Returns the main activity class that the error activity must launch when a com.ywwxhz.crash occurs.
     *
     * @return The class, or null if not set.
     */
    ...
    /**
     * Sets the main activity class that the error activity must launch when a com.ywwxhz.crash occurs.
