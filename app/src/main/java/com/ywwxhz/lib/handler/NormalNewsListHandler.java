 ...
 */
public class NormalNewsListHandler extends ExternedGsonHttpResposerHandler<NewsListService, ResponseObject<NewsListObject>> {

    public NormalNewsListHandler(NewsListService hoder, TypeToken<ResponseObject<NewsListObject>> type) {
        super(hoder, type);
    }
