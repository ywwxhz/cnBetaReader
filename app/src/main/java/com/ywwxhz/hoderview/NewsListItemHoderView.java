...
/**
 * CnbetaReader com.ywwxhz.hoder Created by 远望の无限(ywwxhz) on 2015/2/2 22:31.
 */
public class NewsListItemHoderView extends LinearLayout {
    ...
    public void showNews(NewsItem item, boolean showImage, DisplayImageOptions optionsLarge,
            DisplayImageOptions optionsSmall, NewsListAdapter.AnimateFirstDisplayListener listener) {
